...
public class KustomizeBakeManifestRequest extends BakeManifestRequest {
  ...
  public KustomizeBakeManifestRequest(
    ...
    this.setTemplateRenderer(bakeManifestContext.getTemplateRenderer());
    this.setOutputName(bakeManifestContext.getOutputName());
    this.setInputArtifact(inputArtifact);
    this.setOutputArtifactName(outputArtifactName);
  }
}
